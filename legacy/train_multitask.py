...
from legacy.datasets import (
    make_distance_examples,
    make_nearest_examples,
    build_nearest_and_negative_cache,
)

# Generic training plumbing shared with the active manifold pipeline.
from src.datasets import PairDataset, set_seed, infinite_loader
